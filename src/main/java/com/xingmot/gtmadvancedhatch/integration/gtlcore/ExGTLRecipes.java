    ...
    public static void initRecipes(Consumer<FinishedRecipe> provider) {
        ...
        for (int tier : NET_HIGH_TIERS) {
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_input_hatch_" + VN[tier].toLowerCase() + "_262144a"))
                    .outputItems(ExGTLMachines.NET_LASER_INPUT_HATCH_262144A[tier].asStack())
                    .inputItems(GTLMachines.WIRELESS_ENERGY_INPUT_HATCH_262144A[tier].asStack(4))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_output_hatch_" + VN[tier].toLowerCase() + "_262144a"))
                    .outputItems(ExGTLMachines.NET_LASER_OUTPUT_HATCH_262144A[tier].asStack())
                    .inputItems(GTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_262144A[tier].asStack(4))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_input_hatch_" + VN[tier].toLowerCase() + "_1048576a"))
                    .outputItems(ExGTLMachines.NET_LASER_INPUT_HATCH_1048576A[tier].asStack())
                    .inputItems(GTLMachines.WIRELESS_ENERGY_INPUT_HATCH_1048576A[tier].asStack(4))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_output_hatch_" + VN[tier].toLowerCase() + "_1048576a"))
                    .outputItems(ExGTLMachines.NET_LASER_OUTPUT_HATCH_1048576A[tier].asStack())
                    .inputItems(GTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_1048576A[tier].asStack(4))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_input_hatch_" + VN[tier].toLowerCase() + "_4194304a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_INPUT_HATCH_4194304A[tier].asStack())
                    .inputItems(GTLMachines.WIRELESS_ENERGY_INPUT_HATCH_4194304A[tier].asStack(4))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_output_hatch_" + VN[tier].toLowerCase() + "_4194304a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_OUTPUT_HATCH_4194304A[tier].asStack())
                    .inputItems(GTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_4194304A[tier].asStack(4))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
        ...
        for (int tier : HIGHEST_TIERS) {
            if (gtladd_is_on) {
                ...
                ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_input_hatch_" + VN[tier].toLowerCase() + "_16777216a"))
                        ...
                        .inputItems(ExGTLMachines.WIRELESS_ENERGY_INPUT_HATCH_16777216A[tier - 1].asStack(16))
                        .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                        .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                        .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                        .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
                ...
                ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_output_hatch_" + VN[tier].toLowerCase() + "_16777216a"))
                        .outputItems(ExGTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_16777216A[tier].asStack())
                        .inputItems(ExGTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_16777216A[tier].asStack(16))
                        .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                        .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                        .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                        .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
                ...
                ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_input_hatch_" + VN[tier].toLowerCase() + "_67108864a"))
                        .outputItems(ExGTLMachines.WIRELESS_ENERGY_INPUT_HATCH_67108864A[tier].asStack())
                        .inputItems(ExGTLMachines.WIRELESS_ENERGY_INPUT_HATCH_67108864A[tier].asStack(16))
                        .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                        .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                        .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                        .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
                ...
                ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_output_hatch_" + VN[tier].toLowerCase() + "_67108864a"))
                        .outputItems(ExGTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_67108863A[tier].asStack())
                        .inputItems(ExGTLMachines.WIRELESS_ENERGY_OUTPUT_HATCH_67108863A[tier].asStack(16))
                        .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                        .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                        .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                        .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_input_hatch_" + VN[tier].toLowerCase() + "_2147483647a"))
                    ...
                    .inputItems(ExGTLMachines.NET_ENERGY_INPUT_HATCH_67108864A[tier].asStack(16))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
            ...
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_laser_output_hatch_" + VN[tier].toLowerCase() + "_2147483647a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_OUTPUT_HATCH_2147483647A[tier].asStack())
                    .inputItems(ExGTLMachines.NET_ENERGY_OUTPUT_HATCH_67108864A[tier].asStack(16))
                    .inputItems(GTMachines.WORLD_ACCELERATOR[getTierWorldAccelerator(tier)].asStack())
                    .inputItems(GTMachines.POWER_TRANSFORMER[getTierTransformer(tier)].asStack())
                    .inputItems(GTItems.COVER_ENERGY_DETECTOR_ADVANCED.asStack())
                    .inputFluids(GTMaterials.SolderingAlloy.getFluid(576))
        ...
        for (int tier : NET_HIGH_TIERS2) {
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_262144a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_INPUT_HATCH_262144A[tier].asStack())
                    .inputItems(ExGTLMachines.NET_LASER_INPUT_HATCH_262144A[tier].asStack())
                    .duration(400)
                    .EUt(GTValues.VA[tier])
                    .save(provider);
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_energy_input_hatch_" + GTValues.VN[tier].toLowerCase() + "_1048576a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_INPUT_HATCH_1048576A[tier].asStack())
                    .inputItems(ExGTLMachines.NET_LASER_INPUT_HATCH_1048576A[tier].asStack())
                    .duration(400)
                    .EUt(GTValues.VA[tier])
                    .save(provider);
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_262144a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_OUTPUT_HATCH_262144A[tier].asStack())
                    .inputItems(ExGTLMachines.NET_LASER_OUTPUT_HATCH_262144A[tier].asStack())
                    .duration(400)
                    .EUt(GTValues.VA[tier])
                    .save(provider);
            ASSEMBLER_RECIPES.recipeBuilder(GTMAdvancedHatch.id("net_energy_output_hatch_" + GTValues.VN[tier].toLowerCase() + "_1048576a"))
                    .outputItems(ExGTLMachines.NET_ENERGY_OUTPUT_HATCH_1048576A[tier].asStack())
                    .inputItems(ExGTLMachines.NET_LASER_OUTPUT_HATCH_1048576A[tier].asStack())
                    .duration(400)
                    .EUt(GTValues.VA[tier])
                    .save(provider);
        }
